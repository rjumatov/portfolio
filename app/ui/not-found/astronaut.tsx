  ...
  return (
    <div className="relative h-[340px] animate-spin-slow">
      <div className="-translate-1/2 absolute top-1/2 left-1/2 h-[300px] w-[250px]">
        ...
        {/* Head */}
        <div className="absolute top-[34px] left-1/2 h-[80px] w-[97px] -translate-x-1/2 bg-linear-to-r/oklch from-slate-300 to-slate-200 [border-radius:50%] dark:from-slate-200 dark:to-slate-100">
        ...
        {/* Body */}
        <div className="absolute top-[105px] left-1/2 z-10 h-[100px] w-[85px] -translate-x-1/2 bg-linear-to-r/oklch from-slate-300 to-slate-200 [border-radius:40px/20px] dark:from-slate-200 dark:to-slate-100">
        ...
        <div className="absolute right-[75px] bottom-[70px] h-[40px] w-[30px] -rotate-20 bg-slate-200 dark:bg-slate-100">
