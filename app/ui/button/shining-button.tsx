...
export default function ShiningButton({ children, onClick }: Props) {
  return (
    ...
    >
      <span className="absolute top-0 -left-full h-full w-full -skew-x-20 animate-shine bg-gradient-to-r from-transparent via-black/10 to-transparent opacity-0 dark:via-white/40" />
      {children}
    </button>
  )
}
